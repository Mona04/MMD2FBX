...
Morph::Morph(Context* context) : IResource(context)
{
	_typecode = TypeCode::Morph;
...
bool Morph::LoadFromFile(std::wstring_view path)
{
	Clear();
...
bool Morph::SaveToFile(std::wstring_view path)
{
	FileStream stream;
